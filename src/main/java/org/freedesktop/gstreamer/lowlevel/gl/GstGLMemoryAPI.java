...
public interface GstGLMemoryAPI extends com.sun.jna.Library {
     ...
     *
     * Combining GST_MAP_GL with GST_MAP_WRITE has the same semantics as though you
     * are writing to OpenGL. Conversely, combining GST_MAP_GL with GST_MAP_READ has
     * the same semantics as though you are reading from OpenGL.
     */
